...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { article: @cat.article, cat_name: @cat.cat_name, category_id: @cat.category_id, time: @cat.time } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { article: @cat.article, cat_name: @cat.cat_name, category_id: @cat.category_id, time: @cat.time } }
